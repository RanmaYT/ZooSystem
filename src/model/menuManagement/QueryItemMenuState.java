...
public class QueryItemMenuState implements IMenuState{
    ...
    public void writeMenu() {
        ...
        if(itemData.hasItem()) {
            ...
            System.out.println(String.format( TextColor.WHITE_BOLD + "=============== Escolha um %s para consultar =================", itemData.getItemName()));
    ...
    public void doMenuOperations(Input input) {
        ...
        if(itemData.hasItem()) {
            ...
            if(userOption > 0 && userOption <= itemData.getItemList().size()) {
                ...
                System.out.println(TextColor.WHITE_BOLD + "Você deseja continuar buscando itens: ");
